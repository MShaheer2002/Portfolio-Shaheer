...
- **Interactive UI**: Smooth animations using GSAP and ScrollTrigger.
- **Dynamic Content**: Displays GitHub repositories and activity dynamically.
- **Modern Tech Stack**: Built with HTML5, TailwindCSS, and JavaScript.
- **Project Showcase**: Detailed cards for my projects.
- **Contact Form**: Integrated with custom validation.

## 🛠 Tech Stack
- **Frontend**: HTML5, CSS3, JavaScript (ES6+)
- **Styling**: TailwindCSS, Bootstrap 5
- **Animations**: GSAP, Particles.js
- **Icons**: FontAwesome, Devicon

## 📂 Project Structure
```
Portfolio/
├── assets/             # Images and static assets
├── libs/               # External libraries (GSAP, etc.)
...
## 📬 Contact Me
- **Email**: m.shaheershahid12@gmail.com
- **LinkedIn**: [Muhammad Shaheer Shahid](https://www.linkedin.com/in/mshaheer2002/)
- **GitHub**: [@MShaheer2002](https://github.com/MShaheer2002)

---
© 2025 Muhammad Shaheer Shahid. All Rights Reserved.
