...
${data.message}
        ...
        const mailtoLink = `mailto:m.shaheershahid12@gmail.com?subject=${emailSubject}&body=${emailBody}`;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function loadGitHubLanguages(reposData) {
    ...
    sortedLanguages.forEach(([language, count]) => {
      ...
      languageCard.className = 'bg-[#111] p-4 rounded-xl border border-gray-800 text-center hover:border-[#6133E9] transition-all duration-300';

      languageCard.innerHTML = `
        <div class="text-2xl font-bold text-gradient mb-2">${language}</div>
